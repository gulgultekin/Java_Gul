...
public class Constructor2 extends Test {
    ...
    public Constructor2(){
        ...
        //  super(10.5)  // CountLetters parent clasindaki constructorlardan  birini cagirmamiz gerekiyor . ikisi birden cagirilmaz hata verir
    ...
    public static void main(String[] args) {
     ...
     // CountLetters obj2 = new CountLetters(12);//  C A
