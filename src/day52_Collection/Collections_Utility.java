...
public class Collections_Utility {
    ...
    public static void main(String[] args) {
        ...
        list1.addAll(Arrays.asList(10,9,8,7,5,6,4));

        System.out.println(list1); //[[10, 9, 8, 7, 5, 6, 4]  not sorted
...
//reference type<object type>   //constructor accepts any collection type-->(nums)
        ...
        nums = new ArrayList<>(sorted); //yeniden initialize yaptik
         //in collection framework every single class has constructor that accepts any collection type-->(sorted)  returns to it self
        ...
        //2- do not change the insertion order
